...
const iconTitleMappings = {
    "header-logo": "DevHandler",
};

const getIconLinkTitle = (iconName) => {
    return iconTitleMappings[iconName] || "Icon";
};
...
function decorateIcon(span, prefix = "", alt = "") {
    ...
    if (span.parentElement.tagName.toLowerCase() === "a") {
        span.parentElement.setAttribute("title", getIconLinkTitle(iconName));
    }
    const img = document.createElement("img");
