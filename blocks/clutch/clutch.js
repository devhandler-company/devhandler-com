export default function decorate(block) {
  const clutchVersion = block.classList.contains('mini')
    ...
    : '<div class="clutch-widget" data-url="https://widget.clutch.co" data-widget-type="2" data-height="45" data-nofollow="true" data-expandifr="true" data-clutchcompany-id="2366887"><iframe id="iframe-0.21521029878143394" width="100%" src="https://www.devhandler.com/clutch-widget" height="45px" scrolling="no" style="border: none; overflow: hidden; display: block; height: 44px;" title="[object Object]2"></iframe></div>';
