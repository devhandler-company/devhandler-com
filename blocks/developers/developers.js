const getLeftSideContent = (name, text, pictureHtml, index) => {
  const greenClasses = 'block-group developers-body block-group-end bg-gray-linear border default-padding text-bottom mobile-border-top-none mobile-bg-cyan mobile-border-cyan mobile-color-black block';
