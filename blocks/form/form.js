...
async function createForm(formHref, block) {
...
async function handleSubmit(form) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      thankYouMessage.textContent = 'Thank you for filling out the form! Our team is processing your request and will get in touch with you shortly';
...
export default async function decorate(block) {
  ...
  const form = await createForm(formLink, block);
